    ...
    <StyledFooter id="contact">
      <StyledLetterContainer>
        ...
        <p>
          ...
          by any governmental authority (“Taxes”) associated with your use of
          the Site (including, without limitation, any Taxes that may become
          payable as a result of your ownership, transfer, or growing of any
          Product that is in your ownership).
          <br />
          <br />
          ...
          Game, and the Contracts are provided "as is" and "as available"
          ...
          have no liability or responsibility for any breach of security by any
          party.
          <br />
          <br />
          We shall not be responsible or liable to you for any losses you incur
          as the result of your use of the Ethereum network, and the Metamask
          ...
          error, d) forgotten passwords on your wallet; e) server failure or
          data loss; f) corrupted wallet; g) unauthorized access or activities
          by third parties, including but not limited to the use of viruses,
          phishing, or other means of attack in Metamask.
          <br />
          <br />
          Cryptocurrencies are high risk and intangible digital assets that
          exist only by virtue of the ownership record maintained on the Binance
          ...
          guarantees or promises with respect to Contracts. We are not
          responsible for losses due to blockchains or any other features of the
          Ethereum network.
        </p>
      </StyledLetterContainer>
    </StyledFooter>
