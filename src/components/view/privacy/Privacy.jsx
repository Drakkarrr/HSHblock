  ...
  return (
    <Container className="container mx-auto  pt-14">
      ...
      <p>
        ...
        it’s reasonably necessary for us to do business with you. <br /> 2.2 We
        use your wallet address and email information to: <br /> (a) verify your
        identity; <br /> (b) respond to any feedback, queries or complaints;{" "}
        <br /> (c) provide you with technical support; <br /> (d) take measures
        to detect and prevent fraud, crime or other activity which may cause
        harm to our business or our products and services. <br /> 3. Information
        we may collect 3.1 The personal information we collect about you
        ...
        <br />
        5.1 If you provide us with incomplete or inaccurate information, we may
        not be able to provide you with the products or services that you ask
        for.
        <br /> 6. Consent
        <br /> 6.1 In most cases, we’ll obtain your consent to use and disclose
        wallet address and email information for our intended purposes either
        before or at the time that we collect it.
        <br /> 6.2 If you don’t give us your consent or withdraw your consent,
        we may not be able to provide you with the products or services you ask
        for.
        ...
        only able to provide you with this option when it’s practical for us to
        do so, and if we’re not required by law to identify you.
        <br /> 9. Dealing with unsolicited personal information
        <br /> 9.1 If we receive personal information about you that we haven’t
        ask for, we’ll only retain it if we determine that:
        <br /> (a) the information received is reasonably necessary for us to do
        ...
        systems;
        <br /> (c) encrypting data sent from your computer to our systems during
        internet transactions and client access codes transmitted across
        networks;
        <br /> (d) employing firewalls, intrusion detection systems and virus
        scanning tools to protect against unauthorized persons and viruses from
        ...
        <br /> (f) practicing a clean desk policy for all premises and providing
        secure storage for physical records.
        <br /> 10.4 Where we identify that we no longer need certain personal
        information, we ensure that it’s effectively and securely destroyed. For
        example, we may shred paper records or use other means such as
        degaussing and deletion in the case of electronic equipment and records.
      </p>
    </Container>
  );
};
